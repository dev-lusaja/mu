...
Experience the game with custom features, active development, and a friendly community.`,
    ...
    es: {
        welcomeTitle: "Bienvenido a OpenMU",
        welcomeText: `OpenMU es un emulador de servidor gratuito y de código abierto para MU Online.
Disfruta del juego con características personalizadas, desarrollo activo y una comunidad amigable.`,
        rows: [
            [
                { label: "Experiencia", value: "x50" },
                { label: "Master XP", value: "x30" },
                { label: "Drop Rate", value: "70%" },
            ],
            [
                { label: "Nivel Máximo", value: "400" },
                { label: "Nivel Master Máx", value: "200" },
            ],
            [
                { label: "Max Resets", value: "10" },
                { label: "Puntos por Reset", value: "400" },
            ],
            [
                { label: "Versión", value: "Season 6 Ep 3" },
            ],
            [
                { label: "Discord", value: "Únete a nuestro Discord", url: "https://discord.gg/your-invite" },
            ],
        ],
    }
};
